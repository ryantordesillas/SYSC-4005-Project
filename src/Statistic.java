...
public class Statistic {
    ...
    public void generateReport() {
        ...
        out += "Average processing time for P1: " + (p1_processing / P1_Count)/60;
        out += "\nAverage processing time for P2: " + (p2_processing / P2_Count)/60;
        out += "\nAverage processing time for P3: " + (p3_processing / P3_Count)/60;
        out += "\nThroughput for P1: " + (P1_Count / (total_simulation_time/3.6e9));
        out += "\nThroughput for P2: " + (P2_Count / (total_simulation_time/3.6e9));
